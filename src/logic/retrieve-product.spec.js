...
describe("retrieveProduct", function() {
    ...
    false && it("should fail to retrieve the product if the second parameter is not a function", function() {
        randomProductId = Math.random();

        var callback = "some string";
        expect(function() { retrieveProduct(randomProductId, callback) }).to.throw(TypeError, callback + " is not a function");
